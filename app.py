...
class App:
    ...
    def makeSecVisible(self):
        self.js.document.getElementById('resultSec').style.removeProperty('display');
        
    def makeSecInvisible(self):
        self.js.document.getELementById('uploading').style.display = "none";
...
def predictfile():
    list_of_files = glob.glob('C:/Users/sanja/Desktop/Lannisters/static/uploads/*')
